...
export const metadata: Metadata = {
  title: "Techno Main Salt Lake College",
  description: "Techno Main Salt Lake: Empowering the future with technology.",
  openGraph: {
    title: "Techno Main Salt Lake College",
    description: "Techno Main Salt Lake: Empowering the future with technology.",
    siteName: "Techno Main Salt Lake",
    images: [
      {
        url: "https://images.pexels.com/photos/3764402/pexels-photo-3764402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    description: "Techno Main Salt Lake: Empowering the future with technology.",
    images: [
      "https://images.pexels.com/photos/3764402/pexels-photo-3764402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
    ]
  },
  robots: {
    index: true,
